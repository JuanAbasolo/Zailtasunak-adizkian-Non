...
\renewcommand{\figurename}{irudia} % Euskeratzean, letra larriz ez agertzeko
\renewcommand{\tablename}{taula} % Euskeratzean, letra larriz ez agertzeko

\AddToShipoutPictureFG{
  \AtPageCenter{% or \AtTextCenter
    \makebox[0pt]{\rotatebox[origin=c]{45}{%
      \scalebox{5}{\texttransparent{0.2}{ZIRRIBORROA V2}}%
    }}
  }
}
...
```{r ezetzNGvLZ0fig, fig.cap="Fonazio luzatuak eta aditz nagusien banaketa baiezko eta ezezko esaldietan"}
...
```{r laguntzailefig, fig.cap="Fonazio luzatua aurrekoan eta aditz laguntzaileak eta trinkoak"}
